**Please refer to the issues and try to solve those issues(This is important). We are only accepting solutions for the issues.  We will update the issues list, so keep in touch.**
